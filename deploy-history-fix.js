...
// Configuration
const GITHUB_TOKEN = 'process.env.GITHUB_TOKEN'; // Re-using provided known token
        ...
        const getReq = https.request(getOptions, (res) => {
            ...
            res.on('end', () => {
                ...
                const putData = JSON.stringify({
                    message: `Update history filter configuration`,
                    content: content,
                    branch: BRANCH,
                    sha: sha
                });
...
async function deploy() {
    console.log(`🔧 Deploying History Filter Fixes...`);
    console.log('-----------------------------------');
